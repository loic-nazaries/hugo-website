...
> Ce blog a été entièrement généré par l'usage de l'IA, comme exercice pour tester Google's NotebookLM: j'ai chargé toutes mes publications comme fichiers `.pdf` dans un nouveau projet et demandé au LLM de produire un résumé de 2 000 mots à propos de mon travail de recherche. Mon prompt était un petit peu plus détaillé que cela, mais le résultat est plutôt bon et j'ai fait très peu de changements.
