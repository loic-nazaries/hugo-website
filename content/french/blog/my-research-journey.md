---
title: 'Dévoiler la « boîte noire » : mon parcours de recherche au cœur microbien de notre planète'
date: 2026-04-25T09:00:00+01:00
image: "images/headers/publication.jpg"
tags: ["microbiologie", "recherche", "méthane", "science du sol", "écologie"]
description: "Du fingerprinting moléculaire multiplexe à la biogéographie à l'échelle nationale — une carrière de recherche consacrée à comprendre comment les microbes du sol régulent le climat terrestre."
draft: false
---
...
Ce billet retrace mon parcours, du développement de nouvelles empreintes moléculaires à la cartographie de la biogéographie de microbes spécialisés à l'échelle nationale.
...
La réponse résidait dans la combinaison de la PCR multiplex avec la sensibilité du T-RFLP (Terminal-Restriction Fragment Length Polymorphism). Cela a abouti au développement du **T-RFLP Multiplex (M-TRFLP)**, une technique permettant la caractérisation simultanée de jusqu'à quatre cibles microbiennes différentes en une seule réaction.
...
## 2. Forêts, feux et rétroactions : le cycle du méthane (doctorat, 2007–2011)
...
**L'inventaire national écossais :**
À partir de 697 échantillons de sol et de 62 propriétés climo-édaphiques, j'ai utilisé une modélisation géostatistique hybride pour cartographier les méthanotrophes. Ce travail a révélé un fascinant **partitionnement de niche** :
